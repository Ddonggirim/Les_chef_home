...
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img) values (5, 1, 5, '다시마 육수를 넣고 ⅔ 정도 넣고 10분 정도 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (6, 1, 6, '나머지 다시마 육수를 모두 넣고 성게알과 액젓을 넣어 5분 정도 더 끓여주세요. 부족한 간은 소금으로 맞춰주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (7, 1, 7, '완성된 성게미역국을 그릇에 담고 밥과 함께 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (8, 2, 1, '곤드레는 깨끗이 씻어 4cm 길이로 잘라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (9, 2, 2, '볼에 반죽 재료와 곤드레를 넣고 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (10, 2, 3, '볼에 양념장 재료를 넣어 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (11, 2, 4, '달군 팬에 약간의 기름을 두른 후 반죽을 올려 얇게 펼쳐주세요. 앞뒤로 노릇하게 구워주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (12, 2, 5, '곤드레 전에 양념장을 곁들여 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (13, 3, 1, '불린 미역은 물에 30초 정도 데친 후 체에 밭쳐 깨끗이 씻어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (14, 3, 2, '물기를 짠 후 먹기 좋은 크기로 잘라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (15, 3, 3, '볼에 미역을 담은 후 양념 재료를 넣어 골고루 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (16, 3, 4, '오이는 얇게 슬라이스로 잘라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (17, 3, 5, '미역이 들어있는 볼에 오이와 물을 넣어 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (18, 3, 6, '마지막에 얼음, 통깨를 뿌려 완성해주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (19, 4, 1, '아욱의 줄기 끝 부분은 꺾어내고 껍질을 벗겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (20, 4, 2, '큰 잎은 먹기 좋은 크기로 찢어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (21, 4, 3, '손질한 아욱은 흐르는 물에 2~3번 씻어주세요. 줄기가 두꺼운 경우 반으로 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (22, 4, 4, '청양고추와 대파는 어슷 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (23, 4, 5, '냄비에 멸치다시마육수를 붓고 된장과 고추장을 넣어 센불에서 끓여 주세요. 육수가 끓어 오르면 아욱과 다진마늘, 청양고추를 넣고 끓여주세요. 마지막으로 대파를 넣어 한소끔 끓인 후 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (24, 5, 1, '김치는 꼭지를 붙인 채 3등분하여 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (25, 5, 2, '볼에 양념 재료를 넣고 섞어 양념장을 만들어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (26, 5, 3, '목살은 큼직하게 잘라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (27, 5, 4, '양파는 굵게 채썰어주세요. 대파와 고추는 어슷하게 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (28, 5, 5, '냄비에 김치를 담고 목살과 양파를 올린 후 양념장과 멸치다시마육수, 된장을 넣어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (29, 5, 6, '끓기 시작하면 불을 중간불로 줄여 1시간 20분 정도 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (30, 5, 7, '마지막에 대파와 홍고추, 청양고추를 넣고 한소끔 끓인 후 목살을 먹기 좋은 크기로 잘라 김치와 함께 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (31, 6, 1, '오이를 가늘게 채 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (32, 6, 2, '김치는 굵게 다져주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (33, 6, 3, '볼에 다진 김치와 양념재료를 넣고 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (34, 6, 4, '끓는 물에 중면을 펼쳐 넣고 면끼리 달라붓지 않도록 저어주세요. 물이 끓어오르면 찬물을 2~3회 반복해서 부어 국수를 삶아주세요. 흐르는 찬물에 중면을 여러 번 씻어 전분기를 없애고 체반에 밭쳐 물기를 빼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (35, 6, 5, '양념장에 삶은 국수를 넣고 버무려주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (36, 6, 6, '접시에 비빔국수를 담고 삶은 달걀과 오이채, 깨를 올려주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (37, 7, 1, '해감한 꼬막은 깨끗이 비벼 씻어주세요. 끓는 물에 청주를 넣어 온도를 떨어뜨린 다음 꼬막을 넣고 한쪽으로 저어주면서 삶다가 입이 벌어지기 시작하면 체로 건져주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (38, 7, 2, '삶은 꼬막은 살만 발라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (39, 7, 3, '볼에 양념 재료를 넣어 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (40, 7, 4, '대파와 청고추는 송송 썰고, 홍고추는 반으로 갈라 씨를 뺀 후 얇게 썰어주세요. 양파는 잘게 다져주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (41, 7, 5, '볼에 양념과 썰어둔 야채, 꼬막살을 넣어 버무려주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (42, 7, 6, '접시에 담아 통깨를 뿌려 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (43, 8, 1, '소고기는 물에 30분 정도 담가 핏물을 제거해주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (44, 8, 2, '양파, 당근은 채 썰고 대파는 길이 7~8cm, 두께 0.5cm 크기로 채 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (45, 8, 3, '배는 껍질을 벗기고 믹서에 곱게 간 뒤 소고기에 넣어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (46, 8, 4, '진간장, 국간장을 넣고 골고루 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (47, 8, 5, '순서 4에 올리고당, 후추, 설탕, 마늘, 맛술을 넣고 잘 버무린 뒤 냉장고에서 30분 정도 숙성시키고 꺼내 기름을 두르지 않은 팬에 넣고 센불로 5분 정도 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (48, 8, 6, '양파, 당근을 넣고 당근이 익을 때까지 2분 정도 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (49, 8, 7, '볶은 불고기 위에 채 썬 대파를 올려서 맛있게 즐겨보세요!', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (50, 9, 1, '감자는 껍질을 벗기고 채칼을 이용해 3mm 정도로 채 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (51, 9, 2, '감자가 부서지지 않도록 찬물에 살살 헹궈 전분질을 빼고 물에 5분 정도 담가주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (52, 9, 3, '체에 밭쳐 물기를 빼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (53, 9, 4, '당근은 감자와 같은 두께로 채썰고 양파는 얇게 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (54, 9, 5, '달군 팬에 기름을 넉넉히 두르고 다진 마늘을 넣고 볶아주세요. 양파, 당근, 감자를 넣어 중간불에서 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (55, 9, 6, '감자가 투명해지면 소금을 넣어 간을 맞춰주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (56, 9, 7, '마지막에 통깨를 뿌려 완성해 주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (57, 10, 1, '불린 미역은 물에 깨끗하게 헹군 후 체에 밭쳐 물기를 빼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (58, 10, 2, '달군 팬에 쇠고기를 넣어 볶다가 참기름을 넣고 쇠고기 겉면의 핏기가 없을 때까지 약불에서 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (59, 10, 3, '다진 마늘을 넣어 볶다가 국간장과 미역을 넣고 3~4분 정도 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (60, 10, 4, '물을 넣고 20~30분 정도 충분히 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (61, 10, 5, '부족한 간은 국간장과 액젓으로 맞춰주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (62, 10, 6, '맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (63, 11, 1, '돼지고기는 먹기 좋은 크기로 썰고 고기 밑간 재료에 10분 정도 재워주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (64, 11, 2, '김치는 소를 털어 낸 후 한입 크기로 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (65, 11, 3, '양파는 채를 썰어주세요. 청양고추와 홍고추, 대파는 어슷하게 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (66, 11, 4, '볼에 양념 재료를 넣어 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (67, 11, 5, '냄비에 고추기름과 대파 반을 넣고 중약불에서 달달 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (68, 11, 6, '파 향이 올라오면 돼지고기를 넣어 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (69, 11, 7, '고기의 표면이 익으면, 김치와 양파를 넣어 한 번 더 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (70, 11, 8, '멸치 다시마 육수를 부어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (71, 11, 9, '양념장을 넣어 5분 정도 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (72, 11, 10, '순두부를 숟가락으로 큼직하게 떠 넣어 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (73, 11, 11, '마지막에 홍고추, 청양고추, 대파를 넣고 달걀노른자를 올린 후 한소끔 끓여 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (74, 12, 1, '떡국용 떡은 찬물에 담갔다가 체에 밭쳐 물기를 빼주세요. 대파는 어슷하게 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (75, 12, 2, '쇠고기는 쇠고기 양념에 10분 정도 재웠다가 팬에 볶아 익혀주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (76, 12, 3, '냄비에 다시마물 5컵을 넣은 후 끓어오르면 떡국용 떡을 넣고, 떡이 익어 부드러워지면 국물양념 재료와 대파를 넣어 1분 정도 더 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (77, 12, 4, '그릇에 떡국을 담고 쇠고기, 대파, (지단 또는 달걀말이) 등을 기호에 따라 올려주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (78, 13, 1, '황태채는 물에 살짝 담갔다가 건져낸 후 먹기 좋게 찢어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (79, 13, 2, '무는 4센치 길이로 굵게 채썰고, 고추는 어슷하게 썰어주세요. 콩나물은 다듬어 깨끗이 씻고 실파는 4센치 길이로 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (80, 13, 3, '냄비에 들기름을 두르고 황태채를 넣어 달달 볶다가 다시마멸치육수를 넣고 10분 정도 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (81, 13, 4, '국물이 뽀얗게 우러나면 무를 넣어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (82, 13, 5, '무가 익으면 콩나물과 국물양념을 넣어 2분 정도 더 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (83, 13, 6, '고추, 실파를 넣고 달걀물을 냄비가장자리에 살짝 둘러 부은 후 한소끔 끓여 불을 꺼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (84, 13, 7, '기호에 따라 새우젓과 청양고추를 가감해서 드시면 더욱 맛있어요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (85, 14, 1, '오징어는 껍질과 내장을 제거하고, 다리와 함께 먹기 좋은 크기로 잘라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (86, 14, 2, '무는 사방 3센치로 나박썰기하고, 대파는 반으로 잘라 4센치 길이로 썰어주세요. 청고추와 홍고추는 어슷하게 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (87, 14, 3, '냄비에 다시마멸치육수와 무를 넣어 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (88, 14, 4, '무가 투명해지면 오징어와 양념 재료를 넣어 약 5분간 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (89, 14, 5, '썰어 둔 채소를 넣어 한소끔 더 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (90, 14, 6, '적당한 그릇에 담아 밥과 함께 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (91, 15, 1, '콩나물은 깨끗이 씻어 체에 밭쳐 물기를 빼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (92, 15, 2, '쪽파의 흰뿌리는 반으로 갈라 3센치 길이로 자르고, 청양고추는 어슷하게 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (93, 15, 3, '냄비에 멸치 다시마 육수를 넣어 끓으면 다진 마늘을 넣어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (94, 15, 4, '새우젓을 넣어 간을 맞춰주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (95, 15, 5, '콩나물을 넣고 3분 정도 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (96, 15, 6, '쪽파와 청양고추를 넣어 2분 정도 끓이고, 부족한 간은 소금으로 맞춘 후 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (97, 16, 1, '묵은지와 두부는 적당한 크기로 썰어주세요. 양파는 채썰고, 대파와 청양고추는 어슷 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (98, 16, 2, '달군냄비에 들기름과 참치캔 기름을 넣고 묵은지와 양파, 설탕을 넣어 양파가 투명해질 때까지 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (99, 16, 3, '물, 다진마늘, 김치국물, 고춧가루, 참치캔을 넣어 중불에서 약 5분간 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (100, 16, 4, '대파와 청양고추, 두부를 넣고 한소끔 더 끓여주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (101, 16, 5, '따뜻할 때 밥과 함께 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (102, 17, 1, '표고버섯은 밑동 부분을 자르고 먹기 좋게 슬라이스해주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (103, 17, 2, '양파는 채를 썰어주세요. 대파는 흰 부분과 푸른 부분을 분리한 후 가늘게 채를 썰어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (104, 17, 3, '볼에 양념재료를 넣고 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (105, 17, 4, '달군 팬에 식용유를 넉넉히 두르고 다진 마늘과 대파 흰 부분을 넣어 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (106, 17, 5, '마늘과 파의 향이 올라오면 표고버섯과 양파를 넣어 볶다가 양념재료를 넣어 졸이듯이 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (107, 17, 6, '마지막에 불을 끄고 대파 푸른 부분을 넣고 참기름을 둘러주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (108, 17, 7, '그릇에 밥을 담고 완성된 표고버섯볶음을 얹은 후 통깨와 레드페퍼를 뿌려 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (109, 18, 1, '양파는 채를 썰고, 스팸은 먹기 좋은 크기로 잘라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (110, 18, 2, '볼에 달걀을 풀어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (111, 18, 3, '볼에 소스 재료를 넣어 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (112, 18, 4, '달군 팬에 식용유를 두른 후 달걀을 넣어 스크램블을 만들고 접시에 덜어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (113, 18, 5, '달군 팬에 스팸을 넣어 노릇하게 볶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (114, 18, 6, '달군 팬에 식용유를 두른 후 양파를 볶다가 숨이 죽으면 소스를 넣어 가볍게 섞은 후 불을 꺼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (115, 18, 7, '그릇에 밥을 담고 밥 위에 볶은 양파와 볶은 스팸, 끝 쪽에는 스크램블을 둘러 담아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (116, 18, 8, '마요네즈를 지그재그로 뿌린 후 쪽파와 통깨를 뿌려 완성해주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (117, 19, 1, '대파는 송송 썰어주세요. 청, 홍고추는 다져주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (118, 19, 2, '볼에 달걀을 풀어준 후 물을 넣고 저어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (119, 19, 3, '달걀 물에 밥과 참치, 대파, 간장을 넣고 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (120, 19, 4, '전자레인지에 5분간 돌려주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (121, 19, 5, '피자치즈와 청, 홍고추를 올린 후 후추를 뿌려주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (122, 19, 6, '전자레인지에 2분 30초간 돌려주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (123, 19, 7, '완성된 달걀밥을 맛있게 즐겨주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (124, 20, 1, '쫄면은 가닥가닥 떼어 주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (125, 20, 2, '볼에 양념 재료를 넣어 섞어주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (126, 20, 3, '끓는물에 콩나물을 넣어 1분 정도 데쳐주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (127, 20, 4, '얼음물에 담가 식혀주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (128, 20, 5, '채반에 받쳐 물기를 빼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (129, 20, 6, '끓는 물에 쫄면을 넣고 저어가며 3~4분간 삶아주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (130, 20, 7, '찬물에 쫄면을 여러 번 씻어 전분기를 없애고 채반에 받쳐 물기를 빼주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (131, 20, 8, '볼에 콩나물, 쫄면, 양념장을 넣고 버무려 주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (132, 20, 9, '삶은 달걀은 반으로 잘라주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
insert into recipe_Step (recipe_Step_Id, recipe_Id, step_Num, step_Way, step_Img)values (133, 20, 10, '그릇에 쫄면을 담고 삶은 달걀과 통깨를 올려 완성해주세요.', '/image1/ListIcon/recipePic/1seaweedSoup1.jpg');
